...
const AddPost = ({ onPostAdded }) => {
    ...
    const [backgroundPatternPreview, setBackgroundPatternPreview] = useState('none');
            ...
            />
                <div
                    style={{
                        ...
                        height: '100px',
                        background:
                            backgroundPattern === 'yellowdots'
                                ? `url(${yellowDots})`
                                : backgroundPattern === 'ladyLiberty'
                                ? `url(${ladyLiberty})`
                                : 'none',
                    }}
                />
...
<select onChange={(e) => setBackgroundPattern(e.target.value)} value={backgroundPattern}>
    <option value="none">None</option>
    <option value="url('../images/ladyliberty.png')">Pattern 1</option>
    <option value="url('/path/to/pattern2.png')">Pattern 2</option>
...
<label>Background Pattern:</label>
                ...
                >
                    Background Pattern for Submission
                </div>
